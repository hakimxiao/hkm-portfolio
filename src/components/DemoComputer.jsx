/*
    MERUBAH SCREEN
       * ada di bagian mesh awal yaitu monitor-screen, yang dimana layarnya di ambil dari txt maka jika ingin
         ubah, ubah txt nya.
         
    GSAP
        * ini untuk membuat pergantian animasi menjadi smoth dan juga ada tambahan effek

    USEEFFECT txt.flipY = false;
